...
<br><br><h1>Enter Number of water can need</h1>
<div class="box_model">
<form onsubmit="updateCan()">

<br><br><label>Enter No of Can</label>
<input type="text" id="adminCanId" maxlength="4" onkeyup="validation()"><br><span id="canUpdateError" style="color:red"></span><br>
